	...
	$(document).ready(function() {
		...
		$("#button03").click(function() {
			$.ajax({
				...
				success : function() {
					console.log("/cont15/met03 성공");
				},
				error : function() {
					console.log("/cont15/met03  실패")
				},
				complete : function() {
					console.log("/cont15/met03  완료")
				}
		...
		$("#button04").click(function() {
			$.ajax({
				...
				success : function(data) {
					console.log("/cont15/met04 성공" + data);
				},
				error : function () {
					console.log("/cont15/met04 실패");
				},
				complete : function() {
					console.log("/cont15/met04 완료");
				}
...
<!-- button#button02{/cont15/met02 200  OK 응답} -->
<button id="button02">/cont15/met02 200  OK 응답</button> <br>

<!-- button#button01{/cont15/met01} -->
<button id="button01">/cont15/met01</button> <br>
